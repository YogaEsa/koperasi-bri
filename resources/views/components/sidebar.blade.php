<aside id="sidebar"
    class="fixed inset-y-0 left-0 z-50 bg-white shadow-strong transform -translate-x-full lg:translate-x-0 sidebar-transition sidebar-full">
    <div class="flex flex-col h-full">
        <!-- Logo & Toggle Button -->
        <div class="flex items-center justify-between h-20 gradient-bri px-6 flex-shrink-0 overflow-hidden">
            <div class="flex items-center space-x-3 min-w-0">
                <div class="logo-container flex-shrink-0 w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-medium cursor-pointer transition-transform hover:scale-105"
                    onclick="toggleSidebarMode()">
                    <img src="{{ asset('assets/images/Logo.png') }}" alt="Logo BRI" class="w-8 h-8 object-contain">
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        navItems.forEach(item => {
            ...
            item.addEventListener('mouseenter', function() {
                ...
                tooltipText.style.top = (rect.top + (rect.height / 2) - (tooltipText
                    .offsetHeight / 2)) + 'px';
