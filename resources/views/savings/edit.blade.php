...
@section('page-title', 'Edit Simpanan')
@section('page-subtitle', 'Perbarui data simpanan')
            ...
            <div class="p-6 lg:p-8 space-y-6">
                ...
                <div>
                    ...
                    <select name="type" id="type" required
                        ...
                        <option value="pokok" selected>Simpanan Pokok</option>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm py-2.5 px-3 border transition-colors"
                              placeholder="Catatan tambahan...">Setoran awal</textarea>
                </div>
            </div>
